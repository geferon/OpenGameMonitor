...
#ifdef DISABLED__cplusplus_winrt
...
#else  // ^^^ DISABLED__cplusplus_winrt ^^^ // vvv !DISABLED__cplusplus_winrt vvv
...
#endif // DISABLED__cplusplus_winrt
...
#if defined(_WIN32) && _WIN32_WINNT >= _WIN32_WINNT_VISTA
#if defined(DISABLED__cplusplus_winrt)
